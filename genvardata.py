...
def main():
    ...
    #print(all_games_df)
    all_games_df.to_csv('./'+'vardata.csv') #output games_df to csv files
    ...
    to_keep_counts = to_keep_counts.rename(columns={'index': 'to_keep', 0: 'count'})

    #print(to_keep_counts)
    to_keep_counts.to_csv('./'+'to_keep_counts.csv')
